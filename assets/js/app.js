...
var rfm = {
  ...
  pageControl: {
    ...
    prev: function() {
      $("#next").delay(250).fadeIn(250);$("#prev").fadeOut(250);$("#page2").fadeOut(250);$("#page1").delay(250).fadeIn(250);
    },
    next: function() {
      $("#next").fadeOut(250);$("#prev").delay(250).fadeIn(250);$("#page2").delay(250).fadeIn(250);$("#page1").fadeOut(250);
    }
  },
  getChannelSequence: {
    init: function() {
  ...
  lightSweep: {
    ...
    run: function(target, speed) {
      $({ A : 0 }).animate({ A : speed },{ step : function(A){
        var dA = 15;
  ...
  mticker: {
    ...
    activate: function() {
      ...
      window.addEventListener('m3k_cloned', function (e) {
      }, false);
    },
  },
